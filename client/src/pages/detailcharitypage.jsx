                    ...
                    <div className="d-flex row mb-5">
                        ...
                        <div className="col">
                            ...
                            <div className="d-flex justify-content-between mb-3 gap-2">
                                <text style={{ color: primaryColor }} className='fw-bold h4'>{formatIDR.format(charity?.donation)}</text>
                                <text className="fs-6 text-secondary">gathered from</text>
                                <text className='fw-bold h4'>{formatIDR.format(charity?.goal)}</text>
                            </div>
                            <div>
                                <ProgressBar animated now={(charity?.donation / charity?.goal) * 100} variant="danger" className="progress mb-3 bg-light" style={{ height: "8px" }} />
                            </div>
                            ...
                            <div className='d-grid gap-2'>
                                ...
                                <ModalTransaction
                                    ...
                                    funderID={state.user.id}
                                    fundraiserID={charity?.user_id}
                                />
                            </div>
                        </div>
                    </div>
